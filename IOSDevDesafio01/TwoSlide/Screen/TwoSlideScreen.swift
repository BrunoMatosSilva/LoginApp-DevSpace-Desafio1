...
protocol TwoSlideScreenProtocol: AnyObject {
    func tappedNextPageButton()
}

class TwoSlideScreen: UIView {

    private weak var delegate: TwoSlideScreenProtocol?
    
    public func delegate(delegate: TwoSlideScreenProtocol?) {
    ...
    private lazy var imgSlide: UIImageView = {
        ...
        img.image = UIImage(named: "imgTwo")
    ...
    private lazy var titleLabel: UILabel = {
        ...
        label.text = "Reach the unknown spot"
    ...
    private lazy var subtitleLabel: UILabel = {
        let label = UILabel()
        label.translatesAutoresizingMaskIntoConstraints = false
        label.text = "To your destination"
    ...
    private lazy var controllSlide: UIImageView = {
        let img = UIImageView()
        img.translatesAutoresizingMaskIntoConstraints = false
        img.image = UIImage(named: "controllPageTwo")
        return img
    }()
    ...
    private func configConstaints() {
        NSLayoutConstraint.activate([
            ...
            imgSlide.topAnchor.constraint(equalTo: safeAreaLayoutGuide.topAnchor, constant: 160),
